  ...
  <>
    ...
    <section className="bg-white mb-12">
        ...
        <div className="bg-white pt-5 border-b-3 border-b-secondary/10 pb-8">
          ...
          <h4 className="text-2xl text-primary font-bold pb-5 font-secondary">See the best picture no matter where you sit</h4>
        ...
        <h4 className="text-2xl text-primary font-bold py-5 font-secondary">Powerful intelligence for perfection</h4>

        ...
        <div className='container'>
            <div className="footer-content grid grid-cols-1 md:grid-cols-4 pt-15 pb-10 md:pb-21 gap-15 ">
              <div className="footer-content-list order-4 md:order-1 max-w-96">
                ...
                <p className='max-w-96 pt-9 pb-6.5 hidden md:block '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              ...
              <div className="footer-content-list order-1 md:order-4">
                ...
                <p className='pt-6 pb-8 max-w-85 text-[16px] font-normal'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor </p>
                <div className='flex items-center gap-7'>
                  <TfiHeadphoneAlt className='text-5xl'/>
                  <div >
                    <h4 className='text-4.5 text-black font-normal'>Have any question?</h4>
                    <p className='text-brand text-[28px] font-semibold'>099 456 789</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="copyright flex justify-center md:justify-between pb-5 md:pb-0">
              ...
              <div className='flex items-center '>
                <h4 className='text-4.5 font-medium text-brand hidden md:block'>Pay With</h4>
                <Link to="/" className='hidden md:block'>
